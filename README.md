...
Um binding para Python da biblioteca em fortran [ncorpos-vi](https://github.com/potalej/ncorpos-valores-iniciais), utilizada no [gravidade-fortran](https://github.com/potalej/gravidade-fortran).
